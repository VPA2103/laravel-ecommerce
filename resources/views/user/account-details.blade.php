...
@section('content')
    ...
    <div class="row">
      ...
      <form name="account_edit_form" action="{{ route('account.update') }}" method="POST" class="needs-validation"
        novalidate="">
        @csrf
        <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-12">
        <div class="form-floating my-3">
        <input type="email" class="form-control" name="email" id="account_email" value="{{ $user->email }}"
          readonly>
        ...
        <div class="col-md-12">
        <div class="form-floating my-3">
        <input type="confirmation_password" class="form-control" id="new_password_confirmation"
